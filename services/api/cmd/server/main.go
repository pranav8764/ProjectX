...
func main() {
	...
	// Seed database with dev session and credentials if running locally/dev and tables are empty
	...
	authGroup.GET("/documents/:id/download", middleware.RequireRoles("admin", "plant_manager", "engineer", "technician", "compliance_officer", "viewer"), handlers.HandleGetDocumentDownloadURL(dbPool, minioClient, bucketName))
