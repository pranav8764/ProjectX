        ...
        {activeTab === 'gaps' ? (
          <div className="glass-panel p-6 rounded-2xl border-slate-800/80 space-y-4">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  onClick={() => exportComplianceCsv(activeTab, filteredGaps, certificates)}
                  className="px-3 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 hover:text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 transition-all"
                >
                      ...
                      <div className="shrink-0 flex items-center gap-2">
                        {isOpen ? (
                          <button
                            ...
                            className="px-3 py-1.5 bg-cyber-emerald hover:bg-emerald-600 active:bg-emerald-700 text-slate-950 font-bold rounded-xl text-xs flex items-center gap-1 transition-all hover:shadow-[0_0_15px_rgba(16,185,129,0.2)]"
                          >
          ...
          <div className="glass-panel p-6 rounded-2xl border-slate-800/80 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
              ...
              <button
                onClick={() => exportComplianceCsv(activeTab, filteredGaps, certificates)}
                className="px-3 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 hover:text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 transition-all self-start sm:self-auto"
              >
                <FileDown className="w-3.5 h-3.5" /> Export CSV
              </button>
            </div>
